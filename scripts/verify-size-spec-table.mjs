...
assert.ok(hasRow(['KV', '有文字區', 'S', '1920 x 480', '750 x 750']));
assert.ok(hasRow(['KV', '純 Banner', 'L', '1920 x 800', '750 x 950']));
assert.ok(hasRow(['活動 Banner + 2 商品', 'Banner 左、2 商品右側橫排', '700 x 350', 'Banner 上、2 商品下方橫排', '750 x 520']));
assert.ok(hasRow(['活動 Banner + 3 商品', 'Banner 左、3 商品右側橫排', '520 x 350', 'Banner 上、3 商品下方橫排', '750 x 520']));
assert.ok(hasRow(['活動 Banner + 4 商品', 'Banner 左、4 商品右側橫排', '328 x 350', 'Banner 上、4 商品下方橫排', '750 x 520']));
