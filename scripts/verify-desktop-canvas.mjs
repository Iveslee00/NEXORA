...
assert(bannerProducts.includes("padding: isMobile ? '24px 16px 32px' : '32px 0 40px'"), 'desktop banner products preview should keep horizontal padding out while using compact vertical spacing');
