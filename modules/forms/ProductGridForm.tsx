...
interface Props { data: ProductGridData; onChange: (data: ProductGridData) => void }

export function ProductGridForm({ data, onChange }: Props) {
          ...
          <div key={product.id} className="border border-slate-700 rounded-lg overflow-hidden">
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-shrink-0 ml-2">
                <button onClick={(e) => { e.stopPropagation(); removeProduct(product.id); }} className="text-slate-500 hover:text-red-400 transition-colors">
                  <Trash2 size={13} />
                </button>
