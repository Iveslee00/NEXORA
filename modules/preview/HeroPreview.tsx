    ...
    <section style={sectionStyle}>
      {!showText ? (
        ...
        <>
          ...
          <div style={{ position: isMobile ? 'relative' : 'absolute', inset: isMobile ? undefined : 0, zIndex: 1, display: 'flex', alignItems: 'center', background: isMobile ? textBg : desktopOverlayBg, color: '#ffffff' }}>
            <div style={{ width: '100%', maxWidth: '1080px', margin: '0 auto', padding: isMobile ? '20px 18px' : '0 40px' }}>
              <div style={{ maxWidth: isMobile ? 'none' : '430px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                ...
                <h1 style={{ fontSize: isMobile ? '1.5rem' : '2.25rem', fontWeight: 800, lineHeight: 1.15, margin: '0 0 10px', color: '#ffffff', ...titleStyle }}>{data.title || 'KV 標題'}</h1>
