...
const moduleColors: Record<string, string> = {
  ...
  'product-features': 'bg-emerald-600/20 text-emerald-400 border-emerald-600/30',
  'product-showcase': 'bg-sky-600/20 text-sky-400 border-sky-600/30',
  'product-scenes': 'bg-teal-600/20 text-teal-400 border-teal-600/30',
  'product-info': 'bg-indigo-600/20 text-indigo-400 border-indigo-600/30',
  'product-benefits': 'bg-lime-600/20 text-lime-400 border-lime-600/30',
  'product-steps': 'bg-blue-600/20 text-blue-400 border-blue-600/30',
  'product-comparison': 'bg-violet-600/20 text-violet-400 border-violet-600/30',
  'product-proof': 'bg-amber-600/20 text-amber-400 border-amber-600/30',
  'product-purchase': 'bg-rose-600/20 text-rose-400 border-rose-600/30',
  // email
